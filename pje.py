...
class Processo:
    ...
    def primeirosite(self):
        ...
        #aguarda_elemento('xpath', '/html/body/div[2]/div[2]/div/div[2]/table/tbody/tr[2]/td/table/tbody/tr[7]/td[2]/input[3]')

        navegador.execute_script('document.getElementById("btnUtilizarApplet").click()')

        #navegador.find_element('xpath', '/html/body/div[2]/div[2]/div/div[2]/table/tbody/tr[2]/td/table/tbody/tr[7]/td[2]/input[3]').click()

        #fechars = navegador.find_elements('xpath', "/html/body/div[2]/div[2]/div/div[2]/table/tbody/tr[2]/td/table/tbody/tr[7]")

        #for fechar in fechars:

        navegador.find_element("id", "btnfechar").click()

        navegador.execute_script('document.getElementById("loginAplicacaoButton").click()')
        ...
        for processo in processos:
            ...
            #navegador.execute_script('processos = ["08078097420174058200", "08090663720174058200", "08997543520204058201", "08007543520184058201"]; for (var processo of processos) { document.getElementById("pesquisarProcessoTerceiroForm:nrProcessoDecoration:nrProcesso").value = processo; document.getElementById("pesquisarProcessoTerceiroForm:searchButton").click(); detalhes= document.getElementById("consultaProcessoTerceirosList:0:j_id271:j_id274");	if (detalhes.length == 0) { continue; }; detalhes.onclick(); document.getElementById("modal:motivacaoDecoration:motivacao").innerHTML = "Consulta processual"; document.getElementById("modal:btnGravar").click(); window.close(); document.getElementById("pesquisarProcessoTerceiroForm:nrProcessoDecoration:nrProcesso").clear();}')
